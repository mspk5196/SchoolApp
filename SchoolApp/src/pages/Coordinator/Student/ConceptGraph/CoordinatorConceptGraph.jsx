...
import BackIcon from '../../../../assets/CoordinatorPage/ConceptGraph/Back.svg';
import CalenderIcon from '../../../../assets/CoordinatorPage/ConceptGraph/Calender.svg';
import SearchIcon from '../../../../assets/CoordinatorPage/ConceptGraph/Search.svg';
import AddIcon from '../../../../assets/CoordinatorPage/ConceptGraph/Add.svg';
import MenuIcon from '../../../../assets/CoordinatorPage/ConceptGraph/Menu.svg';
...
const CoordinatorConceptGraph = ({ navigation, route }) => {
  ...
  const handleCardPress = (concept) => {
    navigation.navigate('CoordinatorConceptProgress', { concept });
  };

  // Handler function for edit option
  const handleEdit = (concept) => {
    // Navigate to edit screen with the concept data
    navigation.navigate('CoordinatorAddConceptGraph', { concept });
  };
  ...
  const handleAddConcept = () => {
    ...
    navigation.navigate('CoordinatorAddConceptGraph');
  };
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        <BackIcon
          ...
          onPress={() => navigation.navigate('CoordinatorStudent', { coordinatorData: route.params?.coordinatorData })}
        />
...
export default CoordinatorConceptGraph;
