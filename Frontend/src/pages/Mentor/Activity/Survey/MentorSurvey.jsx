  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.activityIcons}>
        <TouchableOpacity style={styles.addIcon} onPress={()=>navigation.navigate("MentorSurveyRegister",{mentorData})}>
          <Add />
        </TouchableOpacity>
        <TouchableOpacity style={styles.homeIcon} onPress={()=>navigation.navigate("MentorMain",{mentorData})}>
          <Home />
        </TouchableOpacity>
      </View>
