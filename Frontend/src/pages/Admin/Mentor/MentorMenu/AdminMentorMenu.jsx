          ...
          <MentorCard
            ...
            onPress={() => {
              if (item.title === 'Subject Mentor') {
                navigation.navigate('AdminSubjectMentor');
              } else if (item.title === 'Free hour') {
                navigation.navigate('AdminFreeHour');
              } else if (item.title === 'Mentor List') {
                navigation.navigate('AdminMentorList');
              } else if (item.title === 'Discipline log') {
                navigation.navigate('AdminMentorDisciplineLog');
              }
            }}
          />
        )}
