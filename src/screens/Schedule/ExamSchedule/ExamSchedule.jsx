...
const ExamSchedule = ({navigation}) => {
  ...
  // Frequency options
  const frequencyOptions = ["Don't Repeat", 'Daily', 'Custom'];
  ...
  const handleEditSession = index => {
    ...
    // Set frequency
    const frequency =
      sessionToEdit.frequency === 'One Time'
        ? "Don't Repeat"
        : sessionToEdit.frequency;
  ...
  const handleAddSession = () => {
    const newSession = {
      ...
      frequency:
        selectedFrequency === "Don't Repeat" ? 'One Time' : selectedFrequency,
                  ...
                  <Menu style={{zIndex: 1000}}>
                    ...
                    <MenuOptions
                      ...
                      <MenuOption onSelect={() => handleEditSession(index)}>
                        <Text
                          style={{padding: 10, fontSize: 16, color: '#333333'}}>
                          Edit
                        </Text>
                      </MenuOption>
                        ...
                        <Pressable
                          ...
                          style={[
                            ...
                            customDays.includes(day) &&
                              frequencyStyles.dayButtonSelected,
                          ]}
                          onPress={() => {
                          ...
                          <Text
                            style={[
                              ...
                              customDays.includes(day) &&
                                frequencyStyles.dayTextSelected,
                            ]}>
                            {day}
                          </Text>
                        </Pressable>
                    ...
                    <TouchableOpacity
                      ...
                      <Text
                        style={[
                          ...
                          selectedTime.hour === item
                            ? styles.selectedTimePickerText || {
                                fontWeight: 'bold',
                                color: '#3f51b5',
                              }
                            : styles.unselectedTimePickerText || {
                                color: '#333',
                              },
                        ]}>
                        {item}
                    ...
                    <TouchableOpacity
                      ...
                      style={[
                        ...
                        selectedTime.period === period &&
                          (styles.selectedPeriodPickerItem || {
                            backgroundColor: '#e6e6e6',
                            borderRadius: 8,
                          }),
                      ]}
                      ...
                      <Text
                        style={[
                          ...
                          selectedTime.period === period
                            ? styles.selectedPeriodPickerText || {
                                fontWeight: 'bold',
                                color: '#3f51b5',
                              }
                            : styles.unselectedPeriodPickerText || {
                                color: '#333',
                              },
                        ]}>
                        {period}
