...
import styles from './MaterialsUpdatedMathssty';
import PdfIcon from '../../assets/pdf.svg';
import DeleteIcon from '../../assets/trash.svg';
import Home from '../../assets/entypo_home.svg';
import EditIcon from '../../assets/edit.svg';

const MaterialsUpdatedMaths2 = ({navigation}) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.heading}>Grade 2 – Maths</Text>
...
export default MaterialsUpdatedMaths2;
