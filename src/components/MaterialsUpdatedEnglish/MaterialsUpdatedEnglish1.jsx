...
import styles from './MaterialsUpdatedEnglishsty';
import PdfIcon from '../../assets/pdf.svg';
import DeleteIcon from '../../assets/trash.svg';
import Home from '../../assets/entypo_home.svg';
import EditIcon from '../../assets/edit.svg';

const MaterialsUpdatedEnglish1 = ({navigation}) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.heading}>Grade 1 – English</Text>
...
export default MaterialsUpdatedEnglish1;
