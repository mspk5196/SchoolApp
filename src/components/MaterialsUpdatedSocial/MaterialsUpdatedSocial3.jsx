...
import styles from './MaterialsUpdatedSocialsty';
import PdfIcon from '../../assets/pdf.svg';
import DeleteIcon from '../../assets/trash.svg';
import Home from '../../assets/entypo_home.svg';
import EditIcon from '../../assets/edit.svg';

const MaterialsUpdatedSocial3 = ({navigation}) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.heading}>Grade 3 – Social</Text>
...
export default MaterialsUpdatedSocial3;
