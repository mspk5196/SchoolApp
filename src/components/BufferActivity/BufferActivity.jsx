...
const BufferActivity = ({navigation}) => {
        ...
        <View style={styles.container}>
            ...
            <View style={styles.activityIcons}>
                <View style={styles.AddIcon}>
                    <TouchableOpacity onPress={() => navigation.navigate("Buffact")}><Add /></TouchableOpacity>
                </View>
                <View style={styles.HomeIcon}>
                    <TouchableOpacity onPress={() => navigation.navigate("MentorHomepage")}><Home /></TouchableOpacity>
                </View>
            </View>
