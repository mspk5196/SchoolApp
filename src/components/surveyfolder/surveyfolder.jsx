...
import Userlogo from '../../assets/userlogo.svg'; // Add this if using a user icon
import Checkbox from '../../assets/checkbox.svg'; // Add this if using a checkbox icon
import {
  widthPercentageToDP as wp,
  heightPercentageToDP as hp,
} from 'react-native-responsive-screen';

const SurveyFolder = ({navigation}) => {
    ...
    <View style={styles.container}>
      ...
      <View style={styles.fixedButtonContainer}>
        ...
        <TouchableOpacity
          ...
          onPress={() => navigation.navigate('MentorHomepage')}>
