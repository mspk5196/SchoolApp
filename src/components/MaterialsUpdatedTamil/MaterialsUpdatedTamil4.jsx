...
import styles from './MaterialsUpdatedTamilsty';
import PdfIcon from '../../assets/pdf.svg';
import DeleteIcon from '../../assets/trash.svg';
import Home from '../../assets/entypo_home.svg';
import EditIcon from '../../assets/edit.svg';

const MaterialsUpdatedTamil4 = ({navigation}) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.heading}>Grade 4 – Tamil</Text>
...
export default MaterialsUpdatedTamil4;
